...
| | seed 7 · ORD_04 |
|---|---|
| 순간이동 모드, seed 3·7 주문 10건 정차 40곳 | **38/40 성공 (95 %)**. 파지 높이를 중심 − 3 cm 로 바꾸니 약점이던 머스터드 병이 5/7 → 7/7, 토마토 캔 9/9, 스팸 9/9. 남은 실패 2는 옮기는 중 흔들림(세정제 1, 설탕 상자 1)으로 특정 상품·높이와 무관한 잡음. 궤적을 바꾸는 시도 4가지는 40곳 전체에서 오히려 나빠져(29/40) 되돌렸다 — `docs/LOG.md` (11)(12) |
