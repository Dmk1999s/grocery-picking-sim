...
| | seed 7 · ORD_04 |
|---|---|
| 순간이동 모드, seed 3·7 주문 10건 정차 40곳 | 시도 36 중 **31 성공 (86 %)**. 미시도 4는 전부 물리 시작 때 넘어진 세정제 — "지금 자세로는 못 집음" 판정. 실패 5 중 4는 머스터드 병(둥글고 0.43 kg, 3/7 성공)이 옮기는 중 빠진 것, 1은 스팸 캔(8/9). 토마토 캔 9/9, 설탕 상자 6/6, 세정제(1.1 kg) 5/5. 1~4단 모두 성공 사례 있음 |
