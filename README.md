...
| | seed 7 · ORD_04 |
|---|---|
| 순간이동 모드, seed 3·7 주문 10건 정차 40곳 | **38/40 성공 (95 %)** — 볼록 분해 콜라이더로 바꾼 뒤. 실패 2는 둘 다 머스터드 병(둥글고 0.43 kg, 5/7)이 빼내거나 옮기는 중 빠진 것. 토마토 캔 9/9, 스팸 9/9, 세정제(1.1 kg) 9/9, 설탕 상자 6/6. 1~4단 모두. (볼록껍질 때였을 땐 36 시도 중 31, 세정제 4개가 물리 시작 때 넘어져 미시도) |
