...
| | seed 7 · ORD_04 |
|---|---|
| **빼곡한 진열**에서 (현재 트윈) | 맨 앞 상품 6,112개 중 그리퍼 폭·높이 310, 옆 틈 확보 343, 셋 다 22, 정차 가능까지 **15개 (0.2 %)**. 그 15개로 40회: 30 성공 (75 %) — 미리 오므린 손가락이 옆면을 밀어 헛잡음 5, 옮기는 중 이탈 4, 옆 줄 쓸어 넘어뜨림 1. **결론: 평행 그리퍼는 실제 진열에 안 맞는다. 다음은 흡착** |
